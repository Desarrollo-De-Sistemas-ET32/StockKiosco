...
export default function LogsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#212529] flex items-center justify-center p-4">
      <div className="bg-[#e9edf1] rounded-2xl w-full max-w-5xl p-4 sm:p-6 md:p-8 flex flex-col items-center">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">
          Última actividad
        </h1>

        <div className="bg-[#b3bbc4] rounded-xl p-3 sm:p-4 w-full">
          <div className="bg-[#d5dbe0] rounded-lg p-3 sm:p-4 max-h-80 sm:max-h-96 overflow-y-auto space-y-3 sm:space-y-4">
            {logs.map((log, index) => (
              <div
                key={index}
                className="bg-[#6c757d] text-white rounded-md px-3 sm:px-4 py-2 flex items-start sm:items-center gap-3 sm:gap-4 text-sm sm:text-base"
              >
