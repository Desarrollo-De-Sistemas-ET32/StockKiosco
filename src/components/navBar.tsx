  ...
  return (
    <div className="w-full flex justify-center text-sm text-muted-foreground">
      <NavigationMenu className="flex p-4 flex-col rounded-lg shadow-md bg-var6 dark:bg-var2 gap-10 items-center w-full sm:w-[15vh] sm:flex-row px-15">
        ...
        <NavigationMenuLink
          className="flex justify-center items-center flex-row dark:hover:text-shadow-md/50 dark:text-shadow-var6"
          href="/main"
        >
        ...
        <NavigationMenuLink
          className="flex justify-center items-center flex-row text-foreground dark:hover:text-shadow-md/50 dark:text-shadow-var6"
          href="/inventory"
        >
        ...
        <NavigationMenuLink className="flex justify-center items-center flex-row text-foreground dark:hover:text-shadow-md/50 dark:text-shadow-var6"
        href="/manage">
