    ...
    <main className="min-h-screen bg-background flex items-center justify-center">
      ...
      <Card className="w-lg h-[50vh] border-none bg-var3 z-1 m-5 flex flex-col justify-evenly">
        ...
        <CardFooter className="flex justify-around items-center">
          <button
            type="submit"
            className="bg-background hover:text-background w-full py-2 px-4 text-white rounded-md hover:bg-foreground focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-var3"
          >
            Sign In
          </button>
        </CardFooter>
